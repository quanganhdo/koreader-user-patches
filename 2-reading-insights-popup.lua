...
local PATCH_L10N = {
	...
	ru = {
		...
		["November"] = "Ноябрь",
		["December"] = "Декабрь",
		["second read"] = "сек. чтения",
		["seconds read"] = "сек. чтения",
		["minute read"] = "мин. чтения",
		["minutes read"] = "мин. чтения",
		["hour read"] = "ч. чтения",
		["hours read"] = "ч. чтения",
		["day read"] = "дн. чтения",
		["days read"] = "дн. чтения",
		["page read"] = "стр. прочитано",
		["pages read"] = "стр. прочитано",
		["week in a row"] = "нед. подряд",
		["weeks in a row"] = "нед. подряд",
		["day in a row"] = "дн. подряд",
		["days in a row"] = "дн. подряд",
		["page"] = "стр.",
		["pages"] = "стр.",
		["TODAY"] = "СЕГОДНЯ",
		["No weekly streak"] = "Нет недельной серии",
		["No daily streak"] = "Нет дневной серии",
		["CURRENT STREAK"] = "ТЕКУЩАЯ СЕРИЯ",
		["BEST STREAK"] = "ЛУЧШАЯ СЕРИЯ",
		["DAYS READ PER MONTH"] = "ДНЕЙ ЧТЕНИЯ В МЕСЯЦ",
		["Reading statistics: reading insights"] = "Статистика чтения: аналитика",
		["Unknown"] = "Неизвестно",
		["No books read"] = "Нет прочитанных книг",
		["No books read in %1"] = "Нет книг за %1",
		["No books read in "] = "Нет книг за ",
		["%1 - Book Read (%2)"] = "%1 — прочитано книг (%2)",
		["%1 - Books Read (%2)"] = "%1 — прочитано книг (%2)",
	},
}
