...
local PATCH_L10N = {
	...
	ru = {
		...
		["NEXT CHAPTER"] = "СЛЕД. ГЛАВА",
		["THIS BOOK"] = "ЭТА КНИГА",
		["PACE"] = "ТЕМП",
		["Reading statistics: overview"] = "Статистика чтения: обзор",
		["to go"] = "осталось",
		["to read"] = "читать",
		["read"] = "прочитано",
		["per day"] = "в день",
		...
		["hour"] = "ч.",
		["hours"] = "ч.",
		["week reading"] = "нед. чтения",
		["weeks reading"] = "нед. чтения",
		["month reading"] = "мес. чтения",
		["months reading"] = "мес. чтения",
		["day reading"] = "дн. чтения",
		["days reading"] = "дн. чтения",
		["week to go"] = "нед. осталось",
		["weeks to go"] = "нед. осталось",
		["month to go"] = "мес. осталось",
		["months to go"] = "мес. осталось",
		["day to go"] = "дн. осталось",
		["days to go"] = "дн. осталось",
		["page read"] = "стр. прочитано",
		["pages read"] = "стр. прочитано",
		["page per minute"] = "стр./мин.",
		["pages per minute"] = "стр./мин.",
	},
}
